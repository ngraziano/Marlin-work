...
#define STRING_CONFIG_H_AUTHOR "(Nicolas Graziano, DiscoEasy)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_DISCOEASY
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Autodetect PID
  #define DEFAULT_bedKp 429.99
  #define DEFAULT_bedKi 80.75
  #define DEFAULT_bedKd 572.43
